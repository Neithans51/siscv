					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li>
								<a href="<?php echo constant('URL');?>depart">
						...
						<!--	 alerts	-->
							...
							<!--	End alerts	-->
								    	...
								    	<div class="form-group">
											...
											<div class="col-sm-9">
												<input type="text"  id="oficina"  name="oficina" value="<?php echo $this->depart->ofic; ?>" class="form-control required" placeholder="Escriba su número de Oficina" maxlength='2' minlength="1" onkeyup="javascript:this.value=this.value.toUpperCase();"/>
											</div>
                                        ...
                                        <div class="form-group">
											...
											<div class="col-sm-9">
												<textarea type="text" cols="30" rows="10"  id="nombre"  name="nombre"  class="form-control required" placeholder="Escriba el nombre de su Oficina" maxlength='100' minlength="5" onkeyup="javascript:this.value=this.value.toUpperCase();"/><?php echo $this->depart->descripcion; ?></textarea>
                                            </div>
