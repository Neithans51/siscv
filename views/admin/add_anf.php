...
<html class="fixed">
	<head>
		...
		<title>Anfitriones | Sistema para el Control de Visitas Safonapp</title>
						...
						<?php } ?>
								<section class="panel">
									<header class="panel-heading">
										...
										<a title="Volver" href="<?php echo constant ('URL') . "admin/Anf";?>"><button type="button" class="mb-xs mt-xs mr-xs btn btn-info"><i class="fa fa-arrow-left"></i> <b>Volver</b></button></a>
