					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<?php if($this->vista==1){ ?>
								<li><span>Editar Pase</span></li>
								<?php }else{ ?>
								<li><span>Registrar Pase</span></li>
								<?php } ?>
	...
	<!--Validar campos-->			
                       ...
                       <!-- <div class="col-md-1">
						...
						<?php if($this->vista==1){ ?>
							...
							<form id="form-registro" action="<?php echo constant('URL');?>admin/EditarPase"  method="post" class="form-horizontal">
						<?php }else{?>
							<form id="form-registro" action="<?php echo constant('URL');?>admin/RegistrarPase"  method="post" class="form-horizontal">
						<?php } ?>
								<section class="panel">
									...
									<?php if($this->vista==1){ ?>
										<h2 class="panel-title"> Editar Pase</h2>
										<p class="panel-subtitle">
											Formulario basico para Editar de pases.
										</p>
									<?php }else{ ?>
										<h2 class="panel-title"> Registro de Pase</h2>
										<p class="panel-subtitle">
											Formulario basico para el registro de pases.
										</p>
									<?php }?>
